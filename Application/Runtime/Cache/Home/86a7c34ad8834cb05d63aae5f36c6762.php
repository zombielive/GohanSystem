...
<body>
	...
	<div class="container">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<input type="number" class="form-control" id="priceInput" value="<?php echo ($price); ?>">
			<br>
	...
	$(function(){
		...
		$('#saveBtn').click(function(){
			if(lock == 1){
				...
				$.ajax({
					url:"/GohanSystem/index.php/Home/Teacher/updatefood",
					type:"POST",
					data:{name:name,price:price,id:<?php echo ($_GET['id']); ?>},
